...
int main () {
	...
	cout << "Masuk semester II"<<endl;
	cout << "Masuk semester III"<<endl;
	cout << "Masuk semester IV"<<endl;
	cout << "Masuk semester V"<<endl;
	cout << "Masuk semeste VI"<<endl;
	cout << "Masuk semester VII"<<endl;
	cout << "Masuk semester VIII"<<endl;
	cout << "Mulai Skripsi"<<endl;
	cout << "Sidang"<<endl;
